...
namespace Revit.SDK.Samples.ModelLines.CS
{
    public partial class PointUserControl : UserControl
    {
        ...
        void CoordinateTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            System.Windows.Forms.TextBox numberTextBox = sender as System.Windows.Forms.TextBox;
        ...
        /// <returns>If the string can stand for a number return true, otherwise false</returns>
