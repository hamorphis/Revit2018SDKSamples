        ...
        If (dialog.ShowDialog() = System.Windows.Forms.DialogResult.OK) Then
            ...
            Do While iter.MoveNext()
                ...
                If (dialog.CreatedRadioButton.Checked = True) Then
                    If Not (element.Document.GetElement(element.CreatedPhaseId) Is Nothing) Then
                        If dialog.PhaseCheckedListBox.CheckedItems.Contains(element.Document.GetElement(element.CreatedPhaseId).Name) Then
                ...
                ElseIf (dialog.DemolishedRadioButton.Checked = True) Then
                    If Not (element.Document.GetElement(element.DemolishedPhaseId) Is Nothing) Then
                        If dialog.PhaseCheckedListBox.CheckedItems.Contains(element.Document.GetElement(element.DemolishedPhaseId).Name) Then
                            'put the element found into the elements set passed to this method
                            elements.Insert(element)
                        End If
                    End If
