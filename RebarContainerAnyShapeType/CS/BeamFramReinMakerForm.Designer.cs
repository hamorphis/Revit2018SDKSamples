...
namespace Revit.SDK.Samples.RebarContainerAnyShapeType.CS
{
    partial class BeamFramReinMakerForm
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.barTypeGroupBox.Controls.Add(this.bottomBarLabel);
         ...
         // bottomBarLabel
         // 
         this.bottomBarLabel.AutoSize = true;
         this.bottomBarLabel.Location = new System.Drawing.Point(7, 94);
         this.bottomBarLabel.Name = "bottomBarLabel";
         this.bottomBarLabel.Size = new System.Drawing.Size(62, 13);
         this.bottomBarLabel.TabIndex = 3;
         this.bottomBarLabel.Text = "Bottom Bar:";
         // 
         ...
         // okButton
         // 
         this.okButton.Location = new System.Drawing.Point(130, 398);
         ...
         this.cancelButton.Location = new System.Drawing.Point(226, 398);
         ...
         this.Load += new System.EventHandler(this.BeamFramReinMakerForm_Load);
