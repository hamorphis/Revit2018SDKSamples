...
Public Class Command
   ...
   Public Function Execute(ByVal commandData As Autodesk.Revit.UI.ExternalCommandData, ByRef message As String, _
      ...
      For Each elementId In document.Selection.GetElementIds()
         ...
         If TypeOf element Is Autodesk.Revit.DB.Floor Then
            Dim floor As Autodesk.Revit.DB.Floor = element
            selFloor = True

            Dim ii As Integer
            Dim cs As Autodesk.Revit.DB.CompoundStructure = floor.FloorType.GetCompoundStructure
